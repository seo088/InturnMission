const CARDS = [
  ...
  { key:'travel_spot_count',       label:'동물보호센터',    icon:'🏠', color:'#7c3aed', bg:'#ede9fe', from:'#7c3aed', to:'#be185d', desc:'CareRegNo 기반 · 전국 보호센터' },
...
const fmt = (k, v) => {
  if (v == null) return '...'
  if (k === 'animal_registered_count') return v.toLocaleString()
  if (k === 'rdf_triple_count') {
