  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-[14px] mb-[18px]">
        {[
          { label: '수집 원본', value: '272,221건', sub: '14종 · 7개 기관', color: '#64748b' },
          { label: '유효 레코드', value: '55,688건', sub: '원본 대비 유효율 20.4%', color: '#0d9488' },
          { label: '데이터 손실률', value: '79.6%', sub: '정제 필요성 근거', color: '#e11d48' },
          { label: '개체 연결 등급', value: 'A 767 · B 2,189 · C 7', sub: 'RFID / 버킷 / 부분 매칭', color: '#7c3aed' },
        ].map(item => (
          <div key={item.label} style={{
            ...
            <div style={{ fontSize: 18, fontWeight: 800, color: item.color, marginBottom: 3 }}>
              {item.value}
            </div>
